...
export async function POST(req) {
  ...
  const message = `You've been invited to join ${account.name} to manage your athletes. Click the link to get access to your account. ${domain}/login?email=${person.primary_contact.email}&account_id=${account.id}&people_id=${person.id}&sign_up=true`;
