      ...
      <PageProvider>
        <DndProvider backend={HTML5Backend}>
          <div className="flex w-full space-x-5">
            <div className="fixed h-screen w-full min-w-[300px] max-w-[300px] rounded-md border border-gray-300 bg-gray-50 p-3">
            ...
            <div className="ml-[325px] w-full bg-white">{children}</div>
          </div>
        </DndProvider>
      </PageProvider>
    </ThemeProvider>
