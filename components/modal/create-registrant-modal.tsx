  ...
  return (
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 md:p-10">
        <h2 className="font-cal text-2xl dark:text-white">Register</h2>

        {/* Add event ID to the form and create a "participant". A participant is a table that has the person_id, event_id */}
...
function CreateSiteFormButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
    >
      {pending ? <LoadingDots color="#808080" /> : <p>Register</p>}
    </button>
  );
}
