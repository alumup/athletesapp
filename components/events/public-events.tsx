...
export default function AccountPublicEvents({ account, profile, selectedDependent }: any) {
                ...
                {events?.map((event: any) => (
                    ...
                    >
                        ...
                        <div className="flex w-64 flex-col justify-between rounded-r-lg bg-lime-50 p-4">
                            ...
                            {event?.rsvp?.find(
                                (rs: any) =>
                                    rs.person_id === (selectedDependent?.to?.id || profile?.people?.id) && rs.status === "paid",
                            ) ? (
                                <Link
